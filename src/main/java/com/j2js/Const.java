...
public class Const {
   ...
   static {
      ...
      f = new Form();
      f.setIns(new Form.Value[] { new Form.Value("", "array"), new Form.Value("", "index"),
            new Form.Value("", "value"), });
      f.setOuts(new Form.Value[] {});
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 0);
      ...
      f = new Form();
      f.setIns(new Form.Value[] { new Form.Value("cat1", "value3"), new Form.Value("cat1", "value2"),
            new Form.Value("cat1", "value1"), });
      f.setOuts(new Form.Value[] { new Form.Value("cat1", "value1"), new Form.Value("cat1", "value3"),
            new Form.Value("cat1", "value2"), new Form.Value("cat1", "value1"), });
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 0);
      
      f = new Form();
      f.setIns(new Form.Value[] { new Form.Value("cat2", "value2"), new Form.Value("cat1", "value1"), });
      f.setOuts(new Form.Value[] { new Form.Value("cat1", "value1"), new Form.Value("cat2", "value2"),
            new Form.Value("cat1", "value1"), });
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 1);
      ...
      f = new Form();
      f.setIns(new Form.Value[] { new Form.Value("cat1", "value2"), new Form.Value("cat1", "value1"), });
      f.setOuts(new Form.Value[] { new Form.Value("cat1", "value2"), new Form.Value("cat1", "value1"),
            new Form.Value("cat1", "value2"), new Form.Value("cat1", "value1"), });
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 0);
      ...
      f.setIns(new Form.Value[] { new Form.Value("cat1", "value3"), new Form.Value("cat1", "value2"),
            new Form.Value("cat1", "value1"), });
      f.setOuts(new Form.Value[] { new Form.Value("cat1", "value2"), new Form.Value("cat1", "value1"),
            new Form.Value("cat1", "value3"), new Form.Value("cat1", "value2"), new Form.Value("cat1", "value1"), });
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 0);
      
      f = new Form();
      f.setIns(new Form.Value[] { new Form.Value("cat1", "value2"), new Form.Value("cat2", "value1"), });
      f.setOuts(new Form.Value[] { new Form.Value("cat2", "value1"), new Form.Value("cat1", "value2"),
            new Form.Value("cat2", "value1"), });
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 1);
      ...
      f = new Form();
      f.setIns(new Form.Value[] { new Form.Value("cat1", "value4"), new Form.Value("cat1", "value3"),
            new Form.Value("cat1", "value2"), new Form.Value("cat1", "value1"), });
      f.setOuts(new Form.Value[] { new Form.Value("cat1", "value2"), new Form.Value("cat1", "value1"),
            new Form.Value("cat1", "value4"), new Form.Value("cat1", "value3"), new Form.Value("cat1", "value2"),
            new Form.Value("cat1", "value1"), });
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 0);
      ...
      f.setIns(new Form.Value[] { new Form.Value("cat1", "value3"), new Form.Value("cat1", "value2"),
            new Form.Value("cat2", "value1"), });
      f.setOuts(new Form.Value[] { new Form.Value("cat2", "value1"), new Form.Value("cat1", "value3"),
            new Form.Value("cat1", "value2"), new Form.Value("cat2", "value1"), });
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 1);
      
      f = new Form();
      f.setIns(new Form.Value[] { new Form.Value("cat2", "value3"), new Form.Value("cat1", "value2"),
            new Form.Value("cat1", "value1"), });
      f.setOuts(new Form.Value[] { new Form.Value("cat1", "value2"), new Form.Value("cat1", "value1"),
            new Form.Value("cat2", "value3"), new Form.Value("cat1", "value2"), new Form.Value("cat1", "value1"), });
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 2);
      
      f = new Form();
      f.setIns(new Form.Value[] { new Form.Value("cat2", "value2"), new Form.Value("cat2", "value1"), });
      f.setOuts(new Form.Value[] { new Form.Value("cat2", "value1"), new Form.Value("cat2", "value2"),
            new Form.Value("cat2", "value1"), });
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 3);
      ...
      f.setOuts(new Form.Value[] {});
      f.setOperands(new Form.Value[] { new Form.Value("byte", "padding"), new Form.Value("byte", "padding"),
            new Form.Value("byte", "padding"), new Form.Value("int", "default"), new Form.Value("int", "low"),
            new Form.Value("int", "high"), });
      i.setForm(f, 0);
      ...
      f.setOuts(new Form.Value[] {});
      f.setOperands(new Form.Value[] { new Form.Value("byte", "padding"), new Form.Value("byte", "padding"),
            new Form.Value("byte", "padding"), new Form.Value("int", "default"), new Form.Value("int", "npairs"), });
      i.setForm(f, 0);
      ...
      f = new Form();
      f.setIns(new Form.Value[] { new Form.Value("", "objectref"), new Form.Value("", "arg1"),
            new Form.Value("", "..."), new Form.Value("", "argN"), });
      f.setOuts(new Form.Value[] {});
      f.setOperands(new Form.Value[] {});
      i.setForm(f, 0);
      ...
      f.setIns(new Form.Value[] { new Form.Value("", "objectref"), new Form.Value("", "arg1"),
            new Form.Value("", "..."), new Form.Value("", "argN"), });
      f.setOuts(new Form.Value[] {});
      f.setOperands(new Form.Value[] { new Form.Value("short", "index"), new Form.Value("byte", "count"),
            new Form.Value("byte", "0"), });
      i.setForm(f, 0);
      ...
      f = new Form();
      f.setIns(new Form.Value[] { new Form.Value("", "count1"), new Form.Value("", "..."),
            new Form.Value("", "countN"), });
      f.setOuts(new Form.Value[] { new Form.Value("object", "arrayref"), });
