// Copyright 2016 Chamomile.js Project. All Rights Reserved.
...
public class J2JSCompiler {
  private static final com.veracloud.logging.Log sLog = LogFactory.get(J2JSCompiler.class);
  ...
  public static void main(String argv[]) throws Exception {
    ...
    compiler.setGenerateLineNumbers(true); // TODO arguments
    compiler.execute();
  }
  // End main
  ...
  public void execute(Assembly assembly) throws Exception {
    ...
    sLog.i("Entry point is: %s#main(java.lang.String[])void", assembly.getEntryPointClassName());
    ...
    if (cacheFile == null) {
      setCacheFile(new File(basedir, "j2js.cache"));
    }
    ...
    sLog.i("Creating assembly " + assembly.getTargetLocation());
    ...
    sLog.i(timesName("Compiled|Compiled", compileCount, "class|classes") +
        ", " + timesName("packed|packed", methodCount, "method|methods") + ".");
    sLog.i("Execution time was %d millis.", (System.currentTimeMillis() - startTime));
