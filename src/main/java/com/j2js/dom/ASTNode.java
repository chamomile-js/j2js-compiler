...
public class ASTNode {
   ...
   // if (endIndex!=Integer.MIN_VALUE && beginIndex!=Integer.MAX_VALUE &&
   // endIndex<beginIndex) {
   // throw new RuntimeException("Begin index greater than end index: " +
   // beginIndex + ">" + endIndex);
   // }
   // }
    ...
    * 
    * @param theBeginIndex
    *           New value of property beginIndex.
    */
    ...
    * 
    * @param endIndex
    *           New value of property endIndex.
    */
